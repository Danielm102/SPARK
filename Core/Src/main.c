...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, DRV_CS_Pin|LED1_Pin|LED2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : DRV_CS_Pin LED1_Pin LED2_Pin */
  GPIO_InitStruct.Pin = DRV_CS_Pin|LED1_Pin|LED2_Pin;
